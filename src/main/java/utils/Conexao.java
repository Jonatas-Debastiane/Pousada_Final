...
public class Conexao {
    ...
    public static Connection getConexao() {
        try {
            String url = System.getenv("DATABASE_URL");//"jdbc:mysql://localhost:3306/db_pousada?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC";
            String user = System.getenv("DB_USER");//"root";
            String pass =  System.getenv("DB_PASSWORD");//"root";
